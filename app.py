...
mydb=mysql.connector.connect(host='localhost',user='root',password='chintu77',db='flaskblog')
with mysql.connector.connect(host='localhost',user='root',password='chintu77',db='flaskblog'):
    cursor=mydb.cursor(buffered=True)
    cursor.execute("create table if not exists register(Username varchar(50) primary key,Mobile varchar(20) unique,Address varchar(50),Email varchar(30),Password varchar(20))")
app=Flask(__name__)
app.secret_key="my secretkey is my love"
@app.route("/")
def home():
